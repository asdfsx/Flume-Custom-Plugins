 ...
 * 
 */
public class HTTPSource extends AbstractSource implements EventDrivenSource,
		Configurable {
	/*
	...
	public void configure(Context context) {
		try {
			...
			poolsize = context.getInteger(
					HTTPSourceConfigurationConstants.CONFIG_POOLSIZE,
					HTTPSourceConfigurationConstants.DEFAULT_POOLSIZE);
